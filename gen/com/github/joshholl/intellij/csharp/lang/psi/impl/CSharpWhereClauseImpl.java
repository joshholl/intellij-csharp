...
public class CSharpWhereClauseImpl extends ASTWrapperPsiElement implements CSharpWhereClause {

  public CSharpWhereClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitWhereClause(this);
