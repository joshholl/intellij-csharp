...
public class CSharpGeneralCatchClauseImpl extends ASTWrapperPsiElement implements CSharpGeneralCatchClause {

  public CSharpGeneralCatchClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitGeneralCatchClause(this);
