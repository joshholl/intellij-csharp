...
public class CSharpInterfaceEventDeclarationImpl extends ASTWrapperPsiElement implements CSharpInterfaceEventDeclaration {

  public CSharpInterfaceEventDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitInterfaceEventDeclaration(this);
