...
public class CSharpClassDeclarationImpl extends ASTWrapperPsiElement implements CSharpClassDeclaration {

  public CSharpClassDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitClassDeclaration(this);
  ...
  @Override
  @Nullable
  public CSharpClassBase getClassBase() {
    return findChildByClass(CSharpClassBase.class);
  }

  @Override
  @NotNull
  public CSharpClassBody getClassBody() {
    return findNotNullChildByClass(CSharpClassBody.class);
  }

  @Override
  @Nullable
  public CSharpClassModifiers getClassModifiers() {
    return findChildByClass(CSharpClassModifiers.class);
  }
