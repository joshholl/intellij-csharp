...
public class CSharpTypeImpl extends ASTWrapperPsiElement implements CSharpType {

  public CSharpTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitType(this);
