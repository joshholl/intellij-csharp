...
public class CSharpFixedParameterImpl extends ASTWrapperPsiElement implements CSharpFixedParameter {

  public CSharpFixedParameterImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitFixedParameter(this);
  ...
  @Override
  @Nullable
  public CSharpDefaultArgument getDefaultArgument() {
    return findChildByClass(CSharpDefaultArgument.class);
  }

  @Override
  @Nullable
  public CSharpParameterModifier getParameterModifier() {
    return findChildByClass(CSharpParameterModifier.class);
  }
