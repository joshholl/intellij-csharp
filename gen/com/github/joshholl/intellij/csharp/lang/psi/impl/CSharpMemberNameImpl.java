...
public class CSharpMemberNameImpl extends ASTWrapperPsiElement implements CSharpMemberName {

  public CSharpMemberNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitMemberName(this);
