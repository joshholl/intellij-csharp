...
public class CSharpPostIncrementExpressionImpl extends ASTWrapperPsiElement implements CSharpPostIncrementExpression {

  public CSharpPostIncrementExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitPostIncrementExpression(this);
