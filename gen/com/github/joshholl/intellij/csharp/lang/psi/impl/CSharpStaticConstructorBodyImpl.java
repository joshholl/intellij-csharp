...
public class CSharpStaticConstructorBodyImpl extends ASTWrapperPsiElement implements CSharpStaticConstructorBody {

  public CSharpStaticConstructorBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitStaticConstructorBody(this);
