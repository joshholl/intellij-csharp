...
public class CSharpAddAccessorDeclarationImpl extends ASTWrapperPsiElement implements CSharpAddAccessorDeclaration {

  public CSharpAddAccessorDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitAddAccessorDeclaration(this);
