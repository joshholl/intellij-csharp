...
public class CSharpClassTypeImpl extends ASTWrapperPsiElement implements CSharpClassType {

  public CSharpClassTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitClassType(this);
