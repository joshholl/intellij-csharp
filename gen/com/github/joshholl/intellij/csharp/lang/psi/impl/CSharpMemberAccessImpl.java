...
public class CSharpMemberAccessImpl extends ASTWrapperPsiElement implements CSharpMemberAccess {

  public CSharpMemberAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitMemberAccess(this);
