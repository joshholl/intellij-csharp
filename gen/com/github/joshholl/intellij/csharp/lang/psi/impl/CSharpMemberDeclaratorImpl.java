...
public class CSharpMemberDeclaratorImpl extends ASTWrapperPsiElement implements CSharpMemberDeclarator {

  public CSharpMemberDeclaratorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitMemberDeclarator(this);
  ...
  @Override
  @Nullable
  public CSharpMemberAccess getMemberAccess() {
    return findChildByClass(CSharpMemberAccess.class);
  }
