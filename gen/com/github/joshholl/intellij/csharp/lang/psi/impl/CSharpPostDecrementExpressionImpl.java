...
public class CSharpPostDecrementExpressionImpl extends ASTWrapperPsiElement implements CSharpPostDecrementExpression {

  public CSharpPostDecrementExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitPostDecrementExpression(this);
