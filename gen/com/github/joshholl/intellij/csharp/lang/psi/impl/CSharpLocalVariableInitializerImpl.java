...
public class CSharpLocalVariableInitializerImpl extends ASTWrapperPsiElement implements CSharpLocalVariableInitializer {

  public CSharpLocalVariableInitializerImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitLocalVariableInitializer(this);
