...
public class CSharpDefaultValueExpressionImpl extends ASTWrapperPsiElement implements CSharpDefaultValueExpression {

  public CSharpDefaultValueExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitDefaultValueExpression(this);
