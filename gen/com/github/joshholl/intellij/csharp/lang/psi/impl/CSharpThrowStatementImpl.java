...
public class CSharpThrowStatementImpl extends ASTWrapperPsiElement implements CSharpThrowStatement {

  public CSharpThrowStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitThrowStatement(this);
