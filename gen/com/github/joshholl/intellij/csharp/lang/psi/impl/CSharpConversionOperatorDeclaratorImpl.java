...
public class CSharpConversionOperatorDeclaratorImpl extends ASTWrapperPsiElement implements CSharpConversionOperatorDeclarator {

  public CSharpConversionOperatorDeclaratorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitConversionOperatorDeclarator(this);
