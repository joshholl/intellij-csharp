...
public class CSharpBaseAccessImpl extends ASTWrapperPsiElement implements CSharpBaseAccess {

  public CSharpBaseAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitBaseAccess(this);
