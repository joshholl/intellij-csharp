...
public class CSharpExpressionListImpl extends ASTWrapperPsiElement implements CSharpExpressionList {

  public CSharpExpressionListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitExpressionList(this);
