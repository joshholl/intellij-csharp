...
public class CSharpGroupClauseImpl extends ASTWrapperPsiElement implements CSharpGroupClause {

  public CSharpGroupClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitGroupClause(this);
