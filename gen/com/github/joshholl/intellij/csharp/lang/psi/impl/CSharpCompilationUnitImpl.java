...
public class CSharpCompilationUnitImpl extends ASTWrapperPsiElement implements CSharpCompilationUnit {

  public CSharpCompilationUnitImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitCompilationUnit(this);
  ...
  @Override
  @Nullable
  public CSharpGlobalAttributes getGlobalAttributes() {
    return findChildByClass(CSharpGlobalAttributes.class);
  }
