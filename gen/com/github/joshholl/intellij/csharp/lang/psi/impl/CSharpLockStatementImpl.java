...
public class CSharpLockStatementImpl extends ASTWrapperPsiElement implements CSharpLockStatement {

  public CSharpLockStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitLockStatement(this);
