...
public class CSharpDelegateTypeImpl extends ASTWrapperPsiElement implements CSharpDelegateType {

  public CSharpDelegateTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitDelegateType(this);
