...
public class CSharpDestructorBodyImpl extends ASTWrapperPsiElement implements CSharpDestructorBody {

  public CSharpDestructorBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitDestructorBody(this);
