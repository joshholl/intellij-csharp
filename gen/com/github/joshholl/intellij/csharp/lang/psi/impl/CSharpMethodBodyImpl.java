...
public class CSharpMethodBodyImpl extends ASTWrapperPsiElement implements CSharpMethodBody {

  public CSharpMethodBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitMethodBody(this);
