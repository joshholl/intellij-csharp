...
public class CSharpReturnStatementImpl extends ASTWrapperPsiElement implements CSharpReturnStatement {

  public CSharpReturnStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitReturnStatement(this);
