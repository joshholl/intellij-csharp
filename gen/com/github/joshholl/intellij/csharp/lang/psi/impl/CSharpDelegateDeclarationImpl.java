...
public class CSharpDelegateDeclarationImpl extends ASTWrapperPsiElement implements CSharpDelegateDeclaration {

  public CSharpDelegateDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitDelegateDeclaration(this);
  ...
  @Override
  @Nullable
  public CSharpDelegateModifiers getDelegateModifiers() {
    return findChildByClass(CSharpDelegateModifiers.class);
  }
