...
public class CSharpOperatorBodyImpl extends ASTWrapperPsiElement implements CSharpOperatorBody {

  public CSharpOperatorBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitOperatorBody(this);
