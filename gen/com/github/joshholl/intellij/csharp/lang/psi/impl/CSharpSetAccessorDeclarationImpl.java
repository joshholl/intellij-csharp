...
public class CSharpSetAccessorDeclarationImpl extends ASTWrapperPsiElement implements CSharpSetAccessorDeclaration {

  public CSharpSetAccessorDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitSetAccessorDeclaration(this);
