...
public class CSharpEnumTypeImpl extends ASTWrapperPsiElement implements CSharpEnumType {

  public CSharpEnumTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitEnumType(this);
