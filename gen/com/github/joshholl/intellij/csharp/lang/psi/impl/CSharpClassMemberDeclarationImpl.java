...
public class CSharpClassMemberDeclarationImpl extends ASTWrapperPsiElement implements CSharpClassMemberDeclaration {

  public CSharpClassMemberDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitClassMemberDeclaration(this);
  ...
  @Override
  @Nullable
  public CSharpDestructorDeclaration getDestructorDeclaration() {
    return findChildByClass(CSharpDestructorDeclaration.class);
  }
