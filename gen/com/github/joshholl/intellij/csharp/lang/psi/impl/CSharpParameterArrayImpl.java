...
public class CSharpParameterArrayImpl extends ASTWrapperPsiElement implements CSharpParameterArray {

  public CSharpParameterArrayImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitParameterArray(this);
  ...
  public CSharpArrayType getArrayType() {
    return findNotNullChildByClass(CSharpArrayType.class);
  }
