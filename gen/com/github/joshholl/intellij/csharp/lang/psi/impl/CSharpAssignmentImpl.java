...
public class CSharpAssignmentImpl extends ASTWrapperPsiElement implements CSharpAssignment {

  public CSharpAssignmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitAssignment(this);
