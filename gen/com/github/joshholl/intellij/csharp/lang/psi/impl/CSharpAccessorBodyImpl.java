...
public class CSharpAccessorBodyImpl extends ASTWrapperPsiElement implements CSharpAccessorBody {

  public CSharpAccessorBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitAccessorBody(this);
