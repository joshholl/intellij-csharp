...
public class CSharpInterfaceMethodDeclarationImpl extends ASTWrapperPsiElement implements CSharpInterfaceMethodDeclaration {

  public CSharpInterfaceMethodDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitInterfaceMethodDeclaration(this);
  ...
  public CSharpTypeParameterList getTypeParameterList() {
    return findNotNullChildByClass(CSharpTypeParameterList.class);
  }
