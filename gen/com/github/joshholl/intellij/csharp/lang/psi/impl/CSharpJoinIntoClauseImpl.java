...
public class CSharpJoinIntoClauseImpl extends ASTWrapperPsiElement implements CSharpJoinIntoClause {

  public CSharpJoinIntoClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitJoinIntoClause(this);
