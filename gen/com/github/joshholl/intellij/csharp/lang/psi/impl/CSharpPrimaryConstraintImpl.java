...
public class CSharpPrimaryConstraintImpl extends ASTWrapperPsiElement implements CSharpPrimaryConstraint {

  public CSharpPrimaryConstraintImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitPrimaryConstraint(this);
