...
public class CSharpCastExpressionImpl extends ASTWrapperPsiElement implements CSharpCastExpression {

  public CSharpCastExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitCastExpression(this);
