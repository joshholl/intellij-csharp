...
public class CSharpInterfaceTypeListImpl extends ASTWrapperPsiElement implements CSharpInterfaceTypeList {

  public CSharpInterfaceTypeListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitInterfaceTypeList(this);
