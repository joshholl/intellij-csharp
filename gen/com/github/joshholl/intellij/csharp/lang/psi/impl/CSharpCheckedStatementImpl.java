...
public class CSharpCheckedStatementImpl extends ASTWrapperPsiElement implements CSharpCheckedStatement {

  public CSharpCheckedStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitCheckedStatement(this);
