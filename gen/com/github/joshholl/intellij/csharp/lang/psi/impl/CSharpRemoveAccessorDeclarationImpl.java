...
public class CSharpRemoveAccessorDeclarationImpl extends ASTWrapperPsiElement implements CSharpRemoveAccessorDeclaration {

  public CSharpRemoveAccessorDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitRemoveAccessorDeclaration(this);
