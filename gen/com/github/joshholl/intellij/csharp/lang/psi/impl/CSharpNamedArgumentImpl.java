...
public class CSharpNamedArgumentImpl extends ASTWrapperPsiElement implements CSharpNamedArgument {

  public CSharpNamedArgumentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitNamedArgument(this);
