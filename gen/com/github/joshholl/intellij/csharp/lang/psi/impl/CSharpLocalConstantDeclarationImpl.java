...
public class CSharpLocalConstantDeclarationImpl extends ASTWrapperPsiElement implements CSharpLocalConstantDeclaration {

  public CSharpLocalConstantDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitLocalConstantDeclaration(this);
