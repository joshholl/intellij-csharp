...
public class CSharpUncheckedStatementImpl extends ASTWrapperPsiElement implements CSharpUncheckedStatement {

  public CSharpUncheckedStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CSharpVisitor) ((CSharpVisitor)visitor).visitUncheckedStatement(this);
